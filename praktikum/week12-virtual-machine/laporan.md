...
1. Mahasiswa mampu melakukan instalasi dan konfigurasi perangkat lunak hypervisor (VirtualBox atau VMware) pada sistem operasi host.

2. Mahasiswa dapat menjalankan proses instalasi sistem operasi di dalam lingkungan virtual (Virtual Machine) hingga sistem dapat beroperasi dengan normal.

3. Mahasiswa mampu mengatur dan menganalisis alokasi sumber daya perangkat keras seperti CPU, RAM, dan kapasitas penyimpanan (storage) pada Virtual Machine.
---
...
3. Pengaturan Urutan Boot: Menyesuaikan Boot Device Order pada tab Motherboard dengan urutan: Optik, Floppy, Hard Disk, dan Jaringan.

4. Aktivasi Fitur Tambahan: Memastikan fitur I/O APIC dan Hardware Clock in UTC sudah dalam posisi tercentang/aktif sesuai pengaturan standar sistem.

5. Instalasi dan Pengujian: Menjalankan VM hingga proses instalasi Ubuntu selesai, kemudian memverifikasi hasilnya dengan membuka aplikasi Firefox di dalam sistem operasi guest tersebut.

6. screenshot hasilnya dan membuat laporan praktikum lalu unggah di github.
---
...
![Screenshot hasil](screenshots/screenshots1.jpeg)

![Screenshot hasil](screenshots/screenshots2.jpeg)

![Screenshot hasil](screenshots/sreenshots3.jpeg)

![Screenshot hasil](screenshots/screenshots4.jpeg)
---
...
Praktikum ini berhasil menginisialisasi dan menjalankan mesin virtual dengan nama Linux_Ubuntu menggunakan sistem operasi Ubuntu 64-bit di atas platform VirtualBox.

Berdasarkan perbandingan yang dilakukan, pengalokasian memori sebesar 4096 MB memberikan performa sistem yang lebih stabil dan responsif saat menjalankan aplikasi seperti Firefox dibandingkan alokasi 2048 MB.
